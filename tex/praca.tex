...
\medskip{\Large\typprace}\\
\bigskip\bigskip\textsc{\Large\autor}\\
...
\addplot[
    ...
    coordinates {
    (0,0)(331,385.1)(662,684.2)(993, 994.1)(1324, 1339.8)
    };
...
Na grafe môžeme vidieť, že parser parsuje jednoznačné vstupy využívajúce slovenskú left-recursive gramatiku v lineárnom čase, a že v priebehu jednej sekundy zvládne vstupy okolo 1000 tokenov,  čo je reálne najväčší vstup aký môže z Multimediálnej čítanky dostať.
...
Dôvodom prečo k tomuto dochádza je, že parser v tomto prípade vykonáva veľa zbytočných krokov($prediction$ a $completetion$), ktoré pre získanie parsu nepotrebuje. Left-recursive gramatika sa naopak dostáva k výsledku úplne priamočiaro\cite{leftRightRecursive}.
\begin{center}
\begin{tikzpicture}[scale=0.9]
\begin{axis}[
yticklabel style={align=right,inner sep=0pt,xshift=-0.1cm}, % No inner sep, to remove whitespace on left, manually offset by given distance
...
\addplot[
   ...
   \addplot[
    ...
    coordinates {
    (0,0)(331,347.3)(662,652.4)(993, 958.1)(1324, 1285.5)
    };
...
Pokiaľ ide o nejednoznačné vstupy, tak zložitosť sa môže pohybovať od lineárnej až po kubickú. S tým, že všetko veľmi záleží od konkrétneho vstupu,  množstva nejednoznačností, ktoré sa v ňom nachádzajú a počtu úplných aj neuplných parsov, ktoré parser vytvorí. Preto tu nebudem uvádzať graf, lebo by nemal veľkú výpovednú hodnotu. 
